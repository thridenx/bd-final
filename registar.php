...
/*
			$insert1 = "INSERT into user(photo)
			SELECT BulkColumn FROM Openrowset (Bulk 'C:\MAMP\htdocs\bd-project\arnold-newman-15_Bernstein.jpg', Single_Blob) as EmployeePicture";
			echo $insert1;	
			$sql1=mysqli_query($db_select, $insert1);
			*/
