                ...
                <div class="container row">
                    <div id="new-team" class="row col-md-6">
                        <form id="registo-equipa" action="team-create.php" method="post">
                            ...
                            <input class=" btn indigo accent-4 button7_input" type="submit" value="Registar">
                    </div>


                    <div id="teamselection" class="row col-md-6">
                        <h4>Equipas existentes:</h4><br><br><br>
                ...
                if (sizeof($array2) == 0) {
                    ...
                    for ($i = 0; $i < sizeof($array2); $i++) {
                       $teamname = htmlentities((string) $array2[$i][1], ENT_COMPAT, 'UTF-8');
                        ...
                        echo '<a class="collection-item" href="./team-view.php?team_id='.$team_id.'">'.$teamname.'</a>';
                    } 
